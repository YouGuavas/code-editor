  ...
  const handleActive = () => {
    ...
    return (
        <div className={handleActive()} onClick={props.setActiveEditor}>
          ...
          <CodeMirror value={props.value} onChange={(e, lang)=>props.setCodeValue(e, lang)} theme={props.theme ? props.theme.theme : null} height='200px' extensions={props.extensions}/>
        </div>
